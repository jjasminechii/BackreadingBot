...
class ConsistencyResubChecker:
    ...
    def _find_submission_fixes(
        ...
        for submission in submissions:
            ...
            # Each week, just change the date to the due date of the assignment to whenever the resubmission was due.
            RESUB_DUE = datetime.fromisoformat("2024-12-13 19:14:00+11:00")
